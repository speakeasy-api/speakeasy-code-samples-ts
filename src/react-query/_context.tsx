...
const SpeakeasyCodeSamplesContext =
  React.createContext<SpeakeasyCodeSamplesCore | null>(null);

export function SpeakeasyCodeSamplesProvider(props: {
...
export function useSpeakeasyCodeSamplesContext(): SpeakeasyCodeSamplesCore {
  ...
  if (value === null) {
    throw new Error(
      "SDK not initialized. Create an instance of SpeakeasyCodeSamplesCore and pass it to <SpeakeasyCodeSamplesProvider />.",
    );
  }
  return value;
}
